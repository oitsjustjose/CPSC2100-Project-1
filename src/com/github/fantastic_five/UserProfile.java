...
public class UserProfile
{
	...
	public UserProfile(String userID, String password, int permLevel, 
	...
	/**
	 * Returns the user's permission level. This value is equal to GUEST, STUDENT, TEACHER, or ADMIN,
	 * depending on which of those the user is.
	 ...
	 * @param password The String which the implicit parameter's password is being compared to
